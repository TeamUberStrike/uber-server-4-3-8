...
{
    /// <summary>
    /// Regroups useful functions for strings
    /// </summary>
    public static class TextUtilities
    {
        ...
        /// <summary>
        /// Do a complete trim including line breaks, tabs and white spaces
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static string Trim(string value)
        {
            if (!String.IsNullOrEmpty(value))
            {
                ...
                str = str.Replace('\t', ' ');
                return str.Trim(TrimCharacters);
            }
            else
            {
                return String.Empty;
        ...
        public static List<int> IndexOfAll(string haystack, string needle)
        {
            ...
            if (!TextUtilities.IsNullOrEmpty(haystack) && !TextUtilities.IsNullOrEmpty(needle))
            {
                ...
                } while (currentIndex > -1 && !TextUtilities.IsNullOrEmpty(haystack));
            }
            return allIndexes;
        }
