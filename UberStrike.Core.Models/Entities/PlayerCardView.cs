...
namespace UberStrike.DataCenter.Common.Entities
{
    ...
    public class PlayerCardView : IComparable
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            {
                PlayerCardView param = obj as PlayerCardView;
                return -(param.Ranking - this.Ranking);
            }
            else
            {
        ...
        {
            string playerDisplay = "[Player: [Name: " + this.Name + "][Cmid: " + this.Cmid + "][Splats: " + this.Splats + "][Shots: " + this.Shots + "][Hits: " + this.Hits + "][Splatted: " + this.Splatted + "][Precision: " + this.Precision + "][Ranking: " + this.Ranking + "][TagName: " + this.TagName + "]]";
