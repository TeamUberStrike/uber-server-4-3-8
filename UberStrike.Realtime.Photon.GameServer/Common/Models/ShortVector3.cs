...
namespace UberStrike.Realtime.Common
{
    public struct ShortVector3
    {
        ...
        {
            short x = (short)CmuneMath.Clamp(v.x * 10, short.MinValue, short.MaxValue);
            short y = (short)CmuneMath.Clamp(v.y * 100, short.MinValue, short.MaxValue);
            short z = (short)CmuneMath.Clamp(v.z * 10, short.MinValue, short.MaxValue);
        ...
        {
            short x = (short)CmuneMath.Clamp(_vector.x * 10, short.MinValue, short.MaxValue);
            short y = (short)CmuneMath.Clamp(_vector.y * 100, short.MinValue, short.MaxValue);
            short z = (short)CmuneMath.Clamp(_vector.z * 10, short.MinValue, short.MaxValue);
