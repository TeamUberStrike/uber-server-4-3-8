// -----------------------------------------------------------------------
// <copyright file="SendGridInvalidEmails.cs" company="">
...
namespace SendGridSdk
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public static class SendGridInvalidEmails
    {
        private const string Endpoint = "invalidemails";

        /// <summary>
        /// Note that if you want the invalid email addresses for a specific day you should use the same date for startDate and endDate
        /// Only the date is taken into account (no time)
        /// http://docs.sendgrid.com/documentation/api/web-api/webapiinvalidemails/#get
        /// </summary>
        /// <param name="startDate"></param>
        /// <param name="endDate"></param>
        /// <returns></returns>
        public static IList<string> GetInvalidEmails(DateTime startDate, DateTime endDate)
        {
