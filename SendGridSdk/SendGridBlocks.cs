// -----------------------------------------------------------------------
// <copyright file="SendGridBlocks.cs" company="">
...
namespace SendGridSdk
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public static class SendGridBlocks
    {
        private const string Endpoint = "blocks";

        /// <summary>
        /// Note that if you want the blocks for a specific day you should use the same date for startDate and endDate
        /// Only the date is taken into account (no time)
        /// http://docs.sendgrid.com/documentation/api/web-api/webapiblocks/#get
        /// </summary>
        /// <param name="startDate"></param>
        /// <param name="endDate"></param>
        /// <returns></returns>
        public static IList<string> GetBlocks(DateTime startDate, DateTime endDate)
        {
