...
{
    /// <summary>
    /// This class computes the Crc32 of a String or a File according to this standard: CRC-32-IEEE 802.3
    /// </summary>
    public class Crc32 : HashAlgorithm
    {
        ...
        /// <summary>
        /// Computes the PhpBB Crc32 of an email
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public Double ComputeEmailHashPhpBB(string email)
        {
            email = UtilsMisc.StandardizeEmail(email);
            this.ComputeHash(TextUtilities.StringToByteArray(email));
            String ret = unchecked((int)this.CrcValue).ToString() + email.Length.ToString();
