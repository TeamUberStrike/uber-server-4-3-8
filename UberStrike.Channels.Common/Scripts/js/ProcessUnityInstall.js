...
function processUnityInstallFlow() {
    ...
    // Spacer
    newHTML += '<div style="height:20px;"></div>';
    ...
    newHTML += '<div style="clear:left; text-align:center; height:275px;">';
    ...
    newHTML += 'style="font-size:11px; float:left; padding:10px 0 0 10px">' + unityInstallFlow['supportLink'] + '</a>';

    newHTML += '<a href="' + unityObject.ua.installUrl + '" onclick="setTimeout(\'wsTracking(2)\', 400); setTimeout(\'nextInstallPage()\', 800); return true;" class="standard_button" style="float:right; font-size: 15px; padding:3px 8px 3px 8px">' + unityInstallFlow['continueStep2Button'] + '</a>';
    ...
    if (channel == 1)
        ...
        newHTML += '"Default.aspx"';
    newHTML += ' class="standard_button" onclick="wsTracking(5); return true;" style="float:right; font-size: 15px; padding:3px 8px 3px 8px">' + unityInstallFlow['cancelStep2Button'] + '</a>';
...
function nextInstallPage() {
    ...
    if (channel != 6) {
        newHTML += '<img src="' + imagesRoot + 'unityinstall/logo.jpg" alt="UberStrike" />';
    }
